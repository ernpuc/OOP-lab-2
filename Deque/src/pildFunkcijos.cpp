...
void pildRandom(deque<studentas>& grupe) {
	...
	deque<string> vardas{ "Lukas", "Matas", "Adomas", "Nojus", "Kajus", "Motiejus", "Markas", "Benas", "Herkus", "Jonas", "Dominykas" };
	deque<string> pavarde{ "Kazlauskas", "Petrauskas", "Jankauskas", "Butkus", "Paulauskas", "Vasiliauskas", "Baranauskas", "Urbonas", "Navickas", "Ramanauskas", "Savickas" };
