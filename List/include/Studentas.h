...
public:
	...
	studentas(string vardas, string pavarde, list<int>paz, int egz) : vardas_(vardas), pavarde_(pavarde), paz_(paz), egz_(egz), galPaz_(0) {};
	...
	void setPaz(list<int> paz) { paz_ = paz; }
